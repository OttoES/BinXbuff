...
class BaseCodeGenerator:
    ...
    def makeDeclFunArgList(self,structt):
        makeFieldListGeneric(self,structt,True, seperator = "," , inclParent = True , inclConst = False ):    
    def makeCallFunArgList(self,structt):
        makeFieldListGeneric(self,structt,False, seperator = "," , inclParent = True , inclConst = False ):    
    def makeClassMemberList(self,structt):
        makeFieldListGeneric(self,structt,True, seperator = ";\n  " , inclParent = False , inclConst = True ):    
    def makeFieldListGeneric(self,structt,inclTypes, seperator = "," , inclParent = True , inclConst = False ):    
        """ Flexble generation of varable list 
        """
        fields    = structt["body"]
        s = ""
