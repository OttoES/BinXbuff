...
class MsgHeader {
 public:
  ...
  uint16_t xxxxx;
  uint16_t __crc2;
  MsgHeader MSG_HEADER_objFactory(void);
  MsgHeader MSG_HEADER_objFactory(uint8_t  buff[],int buflen );
    ...
    */
   int MSG_HEADER_unpack(MsgHeader_t* this,uint8_t  buff[],int buflen );
}; // end class MsgHeader
...
class ReadMsg : public MsgHeader
{
 public:
  ...
  uint16_t rlen;
  uint16_t seqNr2;
  ReadMsg READ_MSG_objFactory(void);
  ReadMsg READ_MSG_objFactory(uint8_t  buff[],int buflen );
   ...
   /* 
    ...
    @return if < 0 : error in data stream (-4: too short, -23: CRC error
    */
   int READ_MSG_unpack(ReadMsg_t* this,uint8_t  buff[],int buflen );
}; // end class ReadMsg
...
class infoLog {
 public:
  ...
  uint32_t res;
  infoLog INFO_LOG_objFactory(void);
  infoLog INFO_LOG_objFactory(uint8_t  buff[],int buflen );
...
class ReadMsgReply : public MsgHeader
{
 public:
  infoLog_t log[];
  ReadMsgReply READ_MSG_REPLY_objFactory(void);
  ReadMsgReply READ_MSG_REPLY_objFactory(uint8_t  buff[],int buflen );
   ...
   /* 
    ...
    @return if < 0 : error in data stream (-4: too short, -23: CRC error
    */
   int READ_MSG_REPLY_unpack(ReadMsgReply_t* this,uint8_t  buff[],int buflen );
...
class SetProfile : public MsgHeader
{
 public:
  ...
  int8_t dlen;
  char addit[];
  SetProfile SET_PROFILE_objFactory(void);
  SetProfile SET_PROFILE_objFactory(uint8_t  buff[],int buflen );
   ...
   /* 
    ...
    @return if < 0 : error in data stream (-4: too short, -23: CRC error
    */
   int SET_PROFILE_unpack(SetProfile_t* this,uint8_t  buff[],int buflen );
...
class DemoIntlFuncCall {
 public:
  ...
  uint8_t infoLen;
  infoLog_t infoarr[];
  DemoIntlFuncCall DEMO_INTL_FUNC_CALL_objFactory(void);
  DemoIntlFuncCall DEMO_INTL_FUNC_CALL_objFactory(uint8_t  buff[],int buflen );
   ...
   /* 
    ...
    @return if < 0 : error in data stream (-4: too short, -23: CRC error
    */
   int DEMO_INTL_FUNC_CALL_unpack(DemoIntlFuncCall_t* this,uint8_t  buff[],int buflen );
