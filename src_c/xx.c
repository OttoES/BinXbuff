...
int  MSGHEADER_packMsg(uint8_t  buff[],int  pos, uint8_t destAddr,uint8_t sourceAddr,uint8_t subCmd,uint16_t seqNr,CRC16_t crc16)
{
...
int  READMSG_packMsg(uint8_t  buff[],int  pos, uint8_t destAddr,uint8_t sourceAddr,uint8_t subCmd,uint16_t seqNr,CRC16_t crc16,uint8_t subCmd,uint16_t seqNr,CRC16_t crc16)
{
...
int  READMSGREPLY_packMsg(uint8_t  buff[],int  pos, uint8_t destAddr,uint8_t sourceAddr,uint8_t subCmd,uint16_t seqNr,CRC16_t crc16,infoLog_t log[],CRC16_t crc16)
{
...
int  SETPROFILE_packMsg(uint8_t  buff[],int  pos, uint8_t destAddr,uint8_t sourceAddr,uint8_t subCmd,uint16_t seqNr,CRC16_t crc16,char surname[],uint8_t fieldvarname,uint8_t gender,int8_t dlen,CRC16_t hdrCrc2,char addit[])
{
